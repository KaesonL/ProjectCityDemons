...
namespace Input
{
	...
	public:
		...
		void SetTriggerButtonSens(float _sens[4]) {
			m_triggerButtonSens[0] = _sens[0];
			m_triggerButtonSens[1] = _sens[1];
			m_triggerButtonSens[2] = _sens[2];
			m_triggerButtonSens[3] = _sens[3];
		}
